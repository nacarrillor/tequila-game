...
const translations = {
    es: {
        ...
        instructions: "Aspira gas H₂ con <strong>Z</strong> &middot; Instala geófonos con <strong>X</strong> &middot; Tómate el tinto de la mesa al llegar",
    ...
    en: {
        ...
        instructions: "Collect H₂ gas with <strong>Z</strong> &middot; Place geophones with <strong>X</strong> &middot; Collect the coffee from the table at the shop",
    ...
    fr: {
        ...
        instructions: "Aspirez le gaz H₂ avec <strong>Z</strong> &middot; Placez les géophones avec <strong>X</strong> &middot; Prenez le café sur la table à la boutique",
